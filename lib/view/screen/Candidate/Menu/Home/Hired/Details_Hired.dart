...
class Details_Hired extends StatelessWidget {
  final String Icon;
  ...
  Widget build(BuildContext context) {
    final Hireds = Provider.of<DetailsHired>(context, listen: false);
                    ...
                    return SliverAppBar(
                      ...
                      flexibleSpace: SizedBox(
                        ...
                        child: JobSearch(
                          ...
                          stats: stats,
                          saveonTap: () {
                            Hireds.Details_Hired();
                          },
                          savechild: (Hireds.isSeved)
